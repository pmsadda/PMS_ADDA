...
const teenPattiService = require(
  "../services/teenpatti.service",
);
  ...
  try {
    ...
    return response
      ...
      .json({
        ...
        message:
          "Teen Patti matchmaking successful.",

        data: result,
      });
  } catch (error) {
    console.error(
      "TEEN PATTI MATCHMAKING ERROR:",
      error,
    );
  ...
  try {
    ...
    return response
      ...
      .json({
        ...
        message:
          "Teen Patti table state loaded.",

        data: result,
      });
  } catch (error) {
    console.error(
      "GET TEEN PATTI TABLE STATE ERROR:",
      error,
    );
