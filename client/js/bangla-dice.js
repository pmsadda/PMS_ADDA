...
(() => {
  ...
  function showToast(
    ...
    DOM.gameToast.textContent =
      String(message);

    DOM.gameToast.className =
      `game-toast is-visible is-${type}`;
  ...
  function updateBetPreview() {
    ...
    if (!symbol) {
      DOM.selectedSymbolText
        .textContent =
        "একটি ছবি নির্বাচন করুন";

      DOM.potentialPayout
        .textContent =
        "সম্ভাব্য payout: ৳0.00";
  ...
  function updateBetControls() {
    ...
    DOM.decreaseBetBtn.disabled =
      !canBet;

    DOM.increaseBetBtn.disabled =
      !canBet;
  ...
  function applyRound(
    ...
    if (
      ...
      DOM.rollInformationText
        .textContent =
        "পছন্দের ছবিতে bet করুন";
    }
  ...
  function showResult(data) {
    ...
    DOM.userResultMessage
      .textContent =
      `${symbol.symbolNameBn} এই round-এর winner।`;
  ...
  function renderUserResult(
    ...
    if (
      ...
      DOM.userResultMessage
        .textContent =
        `আপনার bet refund হয়েছে।`;

      showToast(
        "Dice bet refund হয়েছে",
        "success",
      );
    ...
    if (
      ...
      DOM.userResultMessage
        .textContent =
        `${losingBets} bet এই round-এ জেতেনি।`;
    }
  }
